...
* [Using DTrace stories](https://github.com/NanXiao/using-dtrace-stories) ⭐ 23 | 🐛 0 | 📅 2026-07-17 - A collection of using DTrace to debug system stories.
...
* [lua-usdt](https://github.com/chrisa/lua-usdt) ⭐ 6 | 🐛 0 | 🌐 C | 📅 2013-10-06 - Libusdt bindings for Lua.

#### Node.js

* [node-dtrace-provider](https://github.com/chrisa/node-dtrace-provider) ⭐ 323 | 🐛 25 | 🌐 JavaScript | 📅 2021-06-09 - Native DTrace probes for Node.js apps.

#### Perl

* [perl-Devel-DTrace-Provider](https://github.com/chrisa/perl-Devel-DTrace-Provider) ⭐ 1 | 🐛 1 | 🌐 C | 📅 2012-12-24 - Perl wrapper for libusdt.
...
* [mod\_usdt](https://github.com/davepacheco/mod_usdt) ⭐ 20 | 🐛 1 | 🌐 D | 📅 2014-07-15 - "httpd" DTrace provider.

### Visualization

* [FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,739 | 🐛 173 | 🌐 Perl | 📅 2024-10-20 - Stack trace visualizer.
* [node-stackvis](https://github.com/joyent/node-stackvis) ⭐ 338 | 🐛 10 | 🌐 JavaScript | 📅 2024-07-05 - Stack trace visualizer.
...
Contributions are more than welcome! Please see [contribution guidelines](https://github.com/xen0l/awesome-dtrace/blob/master/CONTRIBUTING.md) ⭐ 163 | 🐛 0 | 🌐 Makefile | 📅 2017-07-21 first.
